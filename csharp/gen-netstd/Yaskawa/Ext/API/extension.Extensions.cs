...
namespace Yaskawa.Ext.API
{
  public static class extensionExtensions
  {
    ...
    public static Dictionary<int, string> DeepCopy(this Dictionary<int, string> source)
    {
      ...
      var tmp3764 = new Dictionary<int, string>(source.Count);
      foreach (var pair in source)
        tmp3764.Add(pair.Key, (pair.Value != null) ? pair.Value : null);
      return tmp3764;
    }
    ...
    public static Dictionary<string, global::Yaskawa.Ext.API.Any> DeepCopy(this Dictionary<string, global::Yaskawa.Ext.API.Any> source)
    {
      ...
      var tmp3765 = new Dictionary<string, global::Yaskawa.Ext.API.Any>(source.Count);
      foreach (var pair in source)
        tmp3765.Add((pair.Key != null) ? pair.Key : null, (pair.Value != null) ? pair.Value.DeepCopy() : null);
      return tmp3765;
    }
    ...
    public static Dictionary<string, global::Yaskawa.Ext.API.Data> DeepCopy(this Dictionary<string, global::Yaskawa.Ext.API.Data> source)
    {
      ...
      var tmp3766 = new Dictionary<string, global::Yaskawa.Ext.API.Data>(source.Count);
      foreach (var pair in source)
        tmp3766.Add((pair.Key != null) ? pair.Key : null, (pair.Value != null) ? pair.Value.DeepCopy() : null);
      return tmp3766;
    }
    ...
    public static HashSet<global::Yaskawa.Ext.API.ControllerEventType> DeepCopy(this HashSet<global::Yaskawa.Ext.API.ControllerEventType> source)
    {
      ...
      var tmp3767 = new HashSet<global::Yaskawa.Ext.API.ControllerEventType>(source.Count);
    ...
    public static HashSet<global::Yaskawa.Ext.API.PendantEventType> DeepCopy(this HashSet<global::Yaskawa.Ext.API.PendantEventType> source)
    {
      ...
      var tmp3768 = new HashSet<global::Yaskawa.Ext.API.PendantEventType>(source.Count);
      foreach (var elem in source)
        tmp3768.Add(elem);
      return tmp3768;
    }
    ...
    public static HashSet<string> DeepCopy(this HashSet<string> source)
    {
      ...
      var tmp3769 = new HashSet<string>(source.Count);
      foreach (var elem in source)
        tmp3769.Add((elem != null) ? elem : null);
      return tmp3769;
    }
    ...
    public static List<List<double>> DeepCopy(this List<List<double>> source)
    {
      ...
      var tmp3770 = new List<List<double>>(source.Count);
      foreach (var elem in source)
        tmp3770.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3770;
    }
    ...
    public static List<double> DeepCopy(this List<double> source)
    {
      ...
      var tmp3771 = new List<double>(source.Count);
      foreach (var elem in source)
        tmp3771.Add(elem);
      return tmp3771;
    }
    ...
    public static List<global::Yaskawa.Ext.API.Any> DeepCopy(this List<global::Yaskawa.Ext.API.Any> source)
    {
      ...
      var tmp3772 = new List<global::Yaskawa.Ext.API.Any>(source.Count);
      foreach (var elem in source)
        tmp3772.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3772;
    }
    ...
    public static List<global::Yaskawa.Ext.API.ControlGroup> DeepCopy(this List<global::Yaskawa.Ext.API.ControlGroup> source)
    {
      ...
      var tmp3773 = new List<global::Yaskawa.Ext.API.ControlGroup>(source.Count);
      foreach (var elem in source)
        tmp3773.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3773;
    }
    ...
    public static List<global::Yaskawa.Ext.API.ControllerEvent> DeepCopy(this List<global::Yaskawa.Ext.API.ControllerEvent> source)
    {
      ...
      var tmp3774 = new List<global::Yaskawa.Ext.API.ControllerEvent>(source.Count);
      foreach (var elem in source)
        tmp3774.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3774;
    }
    ...
    public static List<global::Yaskawa.Ext.API.DataPoint> DeepCopy(this List<global::Yaskawa.Ext.API.DataPoint> source)
    {
      ...
      var tmp3775 = new List<global::Yaskawa.Ext.API.DataPoint>(source.Count);
      foreach (var elem in source)
        tmp3775.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3775;
    }
    ...
    public static List<global::Yaskawa.Ext.API.LoggingEvent> DeepCopy(this List<global::Yaskawa.Ext.API.LoggingEvent> source)
    {
      ...
      var tmp3776 = new List<global::Yaskawa.Ext.API.LoggingEvent>(source.Count);
      foreach (var elem in source)
        tmp3776.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3776;
    }
    ...
    public static List<global::Yaskawa.Ext.API.PendantEvent> DeepCopy(this List<global::Yaskawa.Ext.API.PendantEvent> source)
    {
      ...
      var tmp3777 = new List<global::Yaskawa.Ext.API.PendantEvent>(source.Count);
      foreach (var elem in source)
        tmp3777.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3777;
    }
    ...
    public static List<global::Yaskawa.Ext.API.PropValues> DeepCopy(this List<global::Yaskawa.Ext.API.PropValues> source)
    {
      ...
      var tmp3778 = new List<global::Yaskawa.Ext.API.PropValues>(source.Count);
      foreach (var elem in source)
        tmp3778.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3778;
    }
    ...
    public static List<global::Yaskawa.Ext.API.SimpleControlGroup> DeepCopy(this List<global::Yaskawa.Ext.API.SimpleControlGroup> source)
    {
      ...
      var tmp3779 = new List<global::Yaskawa.Ext.API.SimpleControlGroup>(source.Count);
      foreach (var elem in source)
        tmp3779.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3779;
    }
    ...
    public static List<global::Yaskawa.Ext.API.storageInfo> DeepCopy(this List<global::Yaskawa.Ext.API.storageInfo> source)
    {
      ...
      var tmp3780 = new List<global::Yaskawa.Ext.API.storageInfo>(source.Count);
      foreach (var elem in source)
        tmp3780.Add((elem != null) ? elem.DeepCopy() : null);
      return tmp3780;
    }
    ...
    public static List<long> DeepCopy(this List<long> source)
    {
      ...
      var tmp3781 = new List<long>(source.Count);
      foreach (var elem in source)
        tmp3781.Add(elem);
      return tmp3781;
    }
    ...
    public static List<string> DeepCopy(this List<string> source)
    {
      ...
      var tmp3782 = new List<string>(source.Count);
      foreach (var elem in source)
        tmp3782.Add((elem != null) ? elem : null);
      return tmp3782;
    }
